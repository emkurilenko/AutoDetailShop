namespace AutoStore.DAL.Migrations
{
    ...
    public partial class MigrateDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AutoDetailId = c.Int(nullable: false),
                        ClientProfileId = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AutoDetails", t => t.AutoDetailId, cascadeDelete: true)
                .ForeignKey("dbo.ClientProfiles", t => t.ClientProfileId)
                .Index(t => t.AutoDetailId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Orders", "AutoDetailId", "dbo.AutoDetails");
            ...
            DropIndex("dbo.Orders", new[] { "AutoDetailId" });
